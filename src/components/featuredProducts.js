...
const FeaturedProducts = () => {
  const [added, setAdded] = useState([false, false, false, false]); // Track state for each product
            ...
            <div className="text-center">
              ...
              <button
                ...
                className={`add-to-cart-btn text-white py-2 px-6 rounded-full flex items-center justify-center space-x-2 transition-transform duration-300 ease-in-out ${
                  added[index] ? 'bg-gray-500 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700'
                }`}
