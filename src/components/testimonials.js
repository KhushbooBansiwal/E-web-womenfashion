      ...
      <section className="py-16 bg-gray-50 border-green-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-6 ">
          <div className="bg-white p-6 rounded-lg shadow-lg border-4 border-green-100 transition-transform hover:scale-105">
            <img src={cs1} alt="Customer 1" className="w-16 h-16 rounded-full mx-auto mb-4" />
            <h3 className="text-xl font-semibold">Emily R.</h3>
            <p className="text-gray-600 mt-2">"Amazing quality and super fast shipping! Will definitely buy again."</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg border-4 border-green-100 transition-transform hover:scale-105">
            <img src={cs2} alt="Customer 2" className="w-16 h-16 rounded-full mx-auto mb-4" />
            <h3 className="text-xl font-semibold">John D.</h3>
            <p className="text-gray-600 mt-2">"Excellent service and quality! I love my new products."</p>
            <div className="flex justify-center mt-4">
              <span className="text-yellow-500 text-lg">&#9733;&#9733;&#9733;&#9733;&#9733;</span>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg border-4 border-green-100 transition-transform hover:scale-105">
            <img src={cs3} alt="Customer 3" className="w-16 h-16 rounded-full mx-auto mb-4" />
            <h3 className="text-xl font-semibold">Sarah P.</h3>
            <p className="text-gray-600 mt-2">"Best online shopping experience I've had. Highly recommend!"</p>
            <div className="flex justify-center mt-4">
              <span className="text-yellow-500 text-lg">&#9733;&#9733;&#9733;&#9733;&#9733;</span>
            </div>
          </div>
